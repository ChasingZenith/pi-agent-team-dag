...
- **Needs the manager** — anything that changes an item's assumptions or description, crosses item boundaries, or blocks other work. These go back to the manager to adjust the graph (`task_update`) and sync it.
